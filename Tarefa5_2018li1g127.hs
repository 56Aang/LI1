...
main :: IO ()
main = do
          jog1 <- loadBMP "imagem/nave1.bmp"
          jog2 <- loadBMP "imagem/nave2.bmp"
          jog3 <- loadBMP "imagem/nave3.bmp"
          jog4 <- loadBMP "imagem/nave4.bmp"
          blocoV <- loadBMP "imagem/blocoV.bmp"
          blocoI <- loadBMP "imagem/blocoI.bmp"
          blocoD <- loadBMP "imagem/blocoD.bmp"
          canhao <- loadBMP "imagem/Canhao.bmp"
          laser <- loadBMP "imagem/laser.bmp"
          choque<- loadBMP "imagem/choque.bmp"
          inicio <- loadBMP "imagem/inicio.bmp"
          jogadores <- loadBMP "imagem/jogadores.bmp"
          mapas <- loadBMP "imagem/mapas.bmp"
          mapa1 <- loadBMP "imagem/mapa1.bmp"
          mapa2 <- loadBMP "imagem/mapa2.bmp"
          mapa3 <- loadBMP "imagem/mapa3.bmp"
          tId <- loadBMP "imagem/Ides.bmp"
          tJd <- loadBMP "imagem/Jdes.bmp"
          tLd <- loadBMP "imagem/Ldes.bmp"
          tOd <- loadBMP "imagem/4des.bmp"
          tSd <- loadBMP "imagem/Sdes.bmp"
          tZd <- loadBMP "imagem/5des.bmp"
          tTd <- loadBMP "imagem/Vdes.bmp"
          tIi <- loadBMP "imagem/Iind.bmp"
          tJi <- loadBMP "imagem/Jind.bmp"
          tLi <- loadBMP "imagem/Lind.bmp"
          tOi <- loadBMP "imagem/4ind.bmp"
          tSi <- loadBMP "imagem/Sind.bmp"
          tZi <- loadBMP "imagem/5ind.bmp"
          tTi <- loadBMP "imagem/Vind.bmp"
          fundo <- loadBMP "imagem/fundo.bmp"
          tabela <- loadBMP "imagem/tabela.bmp"
          a0 <- loadBMP "imagem/0.bmp"
          a1 <- loadBMP "imagem/1.bmp"
          a2 <- loadBMP "imagem/2.bmp"
          a3 <- loadBMP "imagem/3.bmp"
          a4 <- loadBMP "imagem/4.bmp"
          a5 <- loadBMP "imagem/5.bmp"
          teditor <- loadBMP "imagem/teditor.bmp"
          vencedor <- loadBMP "imagem/vencedor.bmp"
          menu <- loadBMP "imagem/menu.bmp"
